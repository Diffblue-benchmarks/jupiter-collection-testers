...
```java
class ImmutableListTests extends ListCollection<String> {
  @Override
  public TestListGenerator<String> generator() {
    return (TestStringListGenerator) elements -> ImmutableList.copyOf(elements);
  }
...
```java
class CollectionsSingletonListTests implements ListContract<String> {
  @Override
  public TestListGenerator<String> generator() {
...
class MinimalCollectionTests extends CollectionContract<String> {
  @Override
  public TestCollectionGenerator<String> generator() {
    return (TestStringCollectionGenerator) elements ->
        new MinimalCollection(elements.toArray(new String[0]));
  }
...
class LinkedHashMapValuesTests implements CollectionContract<String> {
  ...
  public TestCollectionGenerator<String> generator() {
    return (TestStringCollectionGenerator) elements -> {
      ...
      int i = 0;
      elements.forEach(e -> map.put(i++, e));
      return map.values();
    };
  }
